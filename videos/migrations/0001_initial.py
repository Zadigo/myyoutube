...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('video', models.FileField(upload_to=videos.utils.stories_directory_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reference', models.CharField(default='112fc5ba58', max_length=15, unique=True)),
        ...
        migrations.AddIndex(
            model_name='story',
            index=models.Index(fields=['video'], name='videos_stor_video_eb4862_idx'),
        ),
        migrations.AddIndex(
            model_name='playlist',
