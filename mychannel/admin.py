...
custom_admin.register(UserChannel, UserChannelAdmin)
custom_admin.register(ChannelPlaylist, ChannelPlaylistAdmin)
custom_admin.register(ChannelTag, ChannelTagAdmin)
