<template>
  <nav class="fixed top-0 left-0 h-(--navbar-height) w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between z-30 bg-white transition-all">
...
const theme = computed(() => {
  return {
    'ps-[calc(var(--sidebar-width)+1rem)]': showSidebar.value,
